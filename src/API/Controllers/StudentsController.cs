...
using Application.Students.Commands.AttendCourse;
...
public class StudentsController : BaseApiController
{
    ...
    public async Task<ActionResult> AttendCourse(string courseId)
    {
        return HandleResult(await Mediator.Send(new AttendCourseCommand(courseId)));
    }
}
